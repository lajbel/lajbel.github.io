...
export const socials = [
	`<a href="https://github.com/lajbel" target="_blank"><i class="fa-brands fa-github"></i></a>`,
...
export const footer = `Made with <i class="fa-solid fa-heart"></i> and <i class="fa-solid fa-fire"></i>  <i class="fa-solid fa-grip-lines-vertical"></i>  Dani Báez (c) 2021`;