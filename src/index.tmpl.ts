...
export const title = "lajbel.land";

// The page

export const name = `LaJBel`;
export const bio = `Hi, I'm <span>Dani</span>, web developer, I like programming, playing videogames, coffee and learning new things ☕<br/><br/>
	I mainly dev videogames, webpages, bots and visuals novels 💥🦋`;
